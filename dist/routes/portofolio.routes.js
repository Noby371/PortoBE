...
import { ExperienceService, EducationService, CertificateService, ContactService, } from "../services/other.service.js";
...
export function createPortfolioRouter() {
    const router = Router();
    createExpressEndpoints(portfolioContract, {
        // ── Auth ─────────────────────────────────────────────────────────────
        auth: {
            login: async ({ body }) => {
            ...
            me: async ({ req }) => {
                ...
                if (!admin) {
                    return { status: 401, body: { message: "Admin tidak ditemukan." } };
                }
        ...
        profile: {
            get: async () => {
                ...
                if (!profile) {
                    return { status: 404, body: { message: "Profil belum dikonfigurasi." } };
                }
        ...
        skills: {
            ...
            update: async ({ params, body, req }) => {
                ...
                if (!skill) {
                    return { status: 404, body: { message: `Skill dengan ID ${params.id} tidak ditemukan.` } };
                }
            ...
            delete: async ({ params, req }) => {
                ...
                return { status: 200, body: { message: "Skill berhasil dihapus." } };
            },
        },
        // ── Projects ─────────────────────────────────────────────────────────
        projects: {
            ...
            getBySlug: async ({ params }) => {
                ...
                if (!project) {
                    return { status: 404, body: { message: `Proyek '${params.slug}' tidak ditemukan.` } };
                }
            ...
            create: async ({ body, req }) => {
                ...
                if (existing) {
                    return { status: 409, body: { message: `Slug '${body.slug}' sudah digunakan.` } };
                }
            ...
            update: async ({ params, body, req }) => {
                ...
                if (!project) {
                    return { status: 404, body: { message: `Proyek dengan ID ${params.id} tidak ditemukan.` } };
                }
                return { status: 200, body: project };
            },
            delete: async ({ params, req }) => {
                ...
                return { status: 200, body: { message: "Proyek berhasil dihapus." } };
            },
        },
        // ── Experience ───────────────────────────────────────────────────────
        experience: {
            ...
            update: async ({ params, body, req }) => {
                ...
                if (!data) {
                    return { status: 404, body: { message: `Experience dengan ID ${params.id} tidak ditemukan.` } };
                }
                return { status: 200, body: data };
            },
            delete: async ({ params, req }) => {
                ...
                return { status: 200, body: { message: "Experience berhasil dihapus." } };
            },
        },
        // ── Education ────────────────────────────────────────────────────────
        education: {
            ...
            update: async ({ params, body, req }) => {
                ...
                if (!data) {
                    return { status: 404, body: { message: `Education dengan ID ${params.id} tidak ditemukan.` } };
                }
                return { status: 200, body: data };
            },
            delete: async ({ params, req }) => {
                ...
                return { status: 200, body: { message: "Education berhasil dihapus." } };
            },
        },
        // ── Certificates ─────────────────────────────────────────────────────
        certificates: {
            ...
            update: async ({ params, body, req }) => {
                ...
                if (!data) {
                    return { status: 404, body: { message: `Sertifikat dengan ID ${params.id} tidak ditemukan.` } };
                }
            ...
            delete: async ({ params, req }) => {
                ...
                await deleteUploadedFile(existing?.imageUrl);
                return { status: 200, body: { message: "Sertifikat berhasil dihapus." } };
            },
        },
        // ── Contact ──────────────────────────────────────────────────────────
        contact: {
            send: async ({ body }) => {
                ...
                return { status: 201, body: { message: "Pesan berhasil terkirim.", id: msg.id } };
            },
            ...
            markRead: async ({ params, req }) => {
                ...
                if (!msg) {
                    return { status: 404, body: { message: `Pesan dengan ID ${params.id} tidak ditemukan.` } };
                }
            ...
            delete: async ({ params, req }) => {
                ...
                return { status: 200, body: { message: "Pesan berhasil dihapus." } };
            },
        },
    }, router);
    return router;
}
//# sourceMappingURL=portofolio.routes.js.map